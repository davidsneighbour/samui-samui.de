...
| `koenig-prajadhipok` | `koenig-prajadhipok` | created | no | no |
| `koenigin suthida` | `koenigin-suthida` | created | no | no |
| `papst franziskus` | `papst-franziskus` | created | no | no |
| `prawit wongsuwan` | `prawit-wongsuwan` | created | no | no |
| `prayuth chan-ocha` | `prayuth-chan-ocha` | existed | no | no |
| `prem tinsulanonda` | `prem-tinsulanonda` | created | no | no |
| `sineenart` | `sineenart` | created | no | no |
| `surayud chulanont` | `surayud-chulanont` | created | no | no |
| `thanathorn juangroongruangkit` | `thanathorn-juangroongruangkit` | created | no | no |
| `thanom kittikachorn` | `thanom-kittikachorn` | created | no | no |
