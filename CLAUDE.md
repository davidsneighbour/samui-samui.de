...
Full project instructions — architecture, commands, working rules, and GitHub
issue/label conventions — live in [AGENTS.md](AGENTS.md). Read that file first;
it applies to every agent working in this repo, not just Claude Code.
