...
project context and decisions live in `PROJECT.md`, and route/system progress
...
```bash
npm install
npm run server   # hugo server, local preview
npm run build    # hugo build + pagefind indexing
```
