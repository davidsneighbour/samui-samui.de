...
/**
 * Restores Hugo-style typography shortcuts in prose Markdown text nodes.
 * Inline code, fenced code, block HTML, raw HTML tags/attributes, and
 * frontmatter are separate mdast nodes, so they are intentionally outside
