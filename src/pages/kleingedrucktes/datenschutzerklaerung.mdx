...
Zur Anzeige der Wetterlage auf Koh Samui ruft unsere Server-Infrastruktur Wetterdaten für einen fest vorgegebenen Standort von Open-Meteo ab. Der Standort der Besucherinnen und Besucher wird dabei weder abgefragt noch übertragen. Die Wetterdaten werden serverseitig zwischengespeichert, sodass beim Aufruf der Website keine direkte Verbindung zwischen dem Browser und Open-Meteo hergestellt wird.

## Einsatz von OpenFreeMap-Karten

Auf einzelnen Seiten kann eine interaktive Karte angezeigt werden. Die Karte wird erst geladen, wenn der jeweilige Kartenbereich im Browser aktiviert bzw. sichtbar wird. Als Darstellungsbibliothek verwenden wir MapLibre GL JS, eine quelloffene Kartenbibliothek. Die Kartenstile, Vektorkacheln, Schrift- und Symbolressourcen werden zunächst über OpenFreeMap (`tiles.openfreemap.org`) geladen.
